...
export default defineConfig(
  ...
  }),
  {
    ...
    */
    reporter: [['html', { outputFolder: 'playwright-report', open: 'never' }], ['list'], ['@azure/microsoft-playwright-testing/reporter'], ['allure-playwright', { outputFolder: 'allure-results' }]],
  }
);
